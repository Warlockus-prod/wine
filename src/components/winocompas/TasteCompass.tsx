...
// Pure wheel geometry lives in @/lib/compass-geometry so its canonical
// invariants (sector order, axes on sector boundaries, every sprite inside
// its own slice) can be unit-tested — see that file's header.
import {
  MAX_INTENSITY,
  RING_COUNT,
  STATE_COUNT,
