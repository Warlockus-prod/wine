...
export default function RestaurantFormat({
  ...
  return (
    <span className={`inline-flex flex-wrap items-center gap-1.5 ${className}`}>
      ...
      {stars > 0 ? (
        <span
          className="inline-flex items-center gap-0.5 rounded-full border border-[var(--color-accent-gold)]/45 bg-[var(--color-accent-gold)]/12 px-2 py-1"
        ...
        <span className="inline-flex items-center gap-1 rounded-full border border-[var(--color-accent-gold)]/45 bg-[var(--color-accent-gold)]/12 px-2 py-1 text-[9px] font-bold tracking-[0.16em] text-[var(--color-accent-gold)] uppercase">
