...
const DISH_RULES: Rule[] = [
  ...
  { match: /(risotto)/, src: "photo-1476124369491-e7addf5db371" },
  { match: /(gnocchi)/, src: "photo-1627308595229-7830a5c91f9f" },
  ...
  { match: /(parmigian|melanzane|eggplant|aubergine)/, src: "photo-1619895092538-128341789043" },
  { match: /(vitello|carpaccio)/, src: "photo-1432139509613-5c4255815697" },
  { match: /(branzino|sea bass|labraks)/, src: "photo-1467003909585-2f8a72700288" },
  ...
  { match: /(tartare|tatar)/, src: "photo-1432139509613-5c4255815697" },
  { match: /(scallop|przegrzeb|coquille)/, src: "photo-1519708227418-c8fd9a32b7a2" },
  ...
  { match: /(tempura)/, src: "photo-1580476262798-bddd9f4b7369" },
  ...
  { match: /(hamachi|crudo|cebiche|ceviche|poke)/, src: "photo-1535399831218-d5bd36d1a6b3" },
  ...
  { match: /(seafood|fish|ryba|crab|lobster|prawn|shrimp|oyster)/, src: "photo-1467003909585-2f8a72700288" },
...
const WINE_RULES: Rule[] = [
  ...
  { match: /(rose|rosé|rosado|rosato)/, src: "photo-1558001373-7b93ee48ffa0" },
  { match: /(dessert|porto|port|tokaji|sauternes|sweet|moscato|ice wine)/, src: "photo-1568213816046-0ee1c42bd559" },
  { match: /(white|blanc|bianco|sauvignon|chardonnay|riesling|pinot grigio|gewurz|chenin|albariño|albarino|verdejo|grüner|gruner|chablis)/, src: "photo-1510812431401-41d2bd2722f3" },
