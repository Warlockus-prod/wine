/**
 * sense-images.ts - the SENSE_IMAGE_MAP below is generated by
 * scripts/gen-sense-images.mts; the RING_* sprite maps are hand-maintained
 * (scratchpad/curate-sprites.mjs prints them for paste after each re-cut).
 */
